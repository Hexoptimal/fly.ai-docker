...
export function setup(opts: { chain: ChainInfo; walletConnectProjectId?: string; url: string; icon: string }): Promise<void>;
...
export function send(to: string, data: string): Promise<string>;
export function receipt(hash: string): Promise<void>;
